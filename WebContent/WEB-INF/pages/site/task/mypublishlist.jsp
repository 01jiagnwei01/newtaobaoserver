...
<jsp:include page="../common/title.jsp" flush="true">
		<jsp:param name="titletype" value="task_mypublish"></jsp:param>
</jsp:include>
			...
			<div style="overflow:hidden;">
				<div style="margin-bottom:-5000px; padding-bottom:5000px;">
					<jsp:include page="../common/leftmenu.jsp" flush="true">
						...
						<jsp:param name="submenu" value="task_mypublish"></jsp:param>
					</jsp:include>
				</div>
				<div style="width:990px; padding:0 40px; background-color:#FFF; padding-bottom:5000px; margin-bottom:-5000px;" class="fr">
					 <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:20px;">
								<tr>
										...
										<td align="center" bgcolor="#4CA4EE" style="color:#fff;">支付总金额</td> 
										<td align="center" bgcolor="#4CA4EE" style="color:#fff;">支付总点数</td> 
								...
								<tr>
										...
										<td align="center"><%= item.getPayPingTaiMoney().add(item.getPayReceiverMoney())%> </td> 
										<td align="center"><%= item.getPayPingTaiPoints().add(item.getPayReceiverPoints())%> </td> 
