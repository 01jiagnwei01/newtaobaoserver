...
<div style="width:100%; height:28px; background-color:#E8E8E8;">
	...
	<%if(userBase != null){
		%>
		<a href="<%=request.getContextPath() %>/reg" style="display:inline-block; padding:5px 15px; background-color:#09f; color:#fff; margin-right:15px;">欢迎您：<%=userBase.getUserName() %></a>
