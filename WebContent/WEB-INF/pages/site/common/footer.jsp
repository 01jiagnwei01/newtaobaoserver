...
<script>
$(function(){
	var SonlineBox_expand =$.cookie('SonlineBox_expand');

	if (!SonlineBox_expand){
		SonlineBox_expand = true;
	}else if(SonlineBox_expand == 'false'){
		SonlineBox_expand = false;
	}
	$("body").Sonline({
		Position:"right",//left或right
		Top:200,//顶部距离，默认200px
		Effect:true, //滚动或者固定两种方式，布尔值：true或false
		DefaultsOpen:SonlineBox_expand, //默认展开：true,默认收缩：false
