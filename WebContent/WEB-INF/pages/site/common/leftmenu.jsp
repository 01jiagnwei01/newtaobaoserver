<%@ page language="java" contentType="text/html; charset=UTF-8"  pageEncoding="UTF-8"%>
			...
			<div style="width:190px; margin-right:20px; background-color:#e1e1e1;" class="fl" >
				...
				<ul>
					...
					<!-- 
					<li><a href="<%=request.getContextPath() %>/site/bind/phone" class="cbc" style="display:inline-block; width:100%; padding:10px 0;"><span style="margin-left:30px;">&nbsp;>&nbsp;绑定手机</span></a></li>
					 -->
						</ul>
				</ul>
