			...
			<div style="width:910px; padding:0 40px; background-color:#FFF;" class="fr">
				...
				<table border="0" cellpadding="0" cellspacing="0" style="margin:10px auto 30px; padding-bottom:30px;   clear:both;">
					...
					<tr>
						...
						<td><input type="text" name="phone"  size="40" id="phone" style="padding:10px 5px; width:260px;" placeholder="请填写常用邮箱"></td>
						<td><span style="font-size:12px; color:#F00;width: 80px" id="phone_error"> </span></td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
						<td>
							<input type="text" name="phone_code" id="phone_code" style="padding:10px 5px; width:110px;" placeholder="请输入验证码">
