...
public class TiXianServiceImpl implements TiXianService {
	...
	public UserBase doapply(UserBase userBase, String alipyAccount,
		...
		userAccountService.updateUserAccount(userBase,BigDecimal.ZERO, amount, BigDecimal.ZERO,BigDecimal.ZERO  , UserAccountTypes.WITHDRAW_APPLY, applyDrawLog.getId(),null);
