	 ...
	 <div data-options="region:'center'">
		 <form id="ff" method="post">
					<table cellpadding="5">
							...
							<tr>
								<td>基本发布点</td>
								<td><input class="easyui-numberbox inputwidth"  name="basicPublishDot" value='0.9' readonly="readonly" data-options="min:0.5,max:90000,precision:2,required:true"></input></td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td>任务类型:</td>
