...
<jsp:include page="../common/title.jsp" flush="true">
		<jsp:param name="titletype" value="task_center"></jsp:param>
</jsp:include>
			...
			<div style="overflow:hidden;">
				<div style="margin-bottom:-5000px; padding-bottom:5000px;">
					<jsp:include page="../common/leftmenu.jsp" flush="true">
						...
						<jsp:param name="submenu" value="task_center"></jsp:param>
					</jsp:include>
				</div>
	...
	var options = {
            ...
            tooltipTitles: function (type, page, current) {
                ...
                pageUrl: function(type, page, current){
					  ...
					  return "<%=request.getContextPath() %>/site/task/task_center?pageno="+(page)+"&limit="+pageSize
