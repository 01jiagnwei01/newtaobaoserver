...
<html lang="zh-CN">
  <head>
    ...
    <![endif]-->
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/resources/games/BlockBlaster/css/normalize.css" />
	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/resources/games/BlockBlaster/css/default.css">
	<style type="text/css">
  ...
  <body>
    ...
    <div class="container">
      <div class="row row-offcanvas row-offcanvas-right">
	       	<div class="col-xs-12 col-sm-12 col-md-12  col-lg-12" id="div1">
					<canvas id="canvas" width="1024" height="600" style="margin-top:70px;"></canvas>
	 		</div>
		</div>
    ...
    function resizeCanvas() {
    	 ...
    	 if(w>1140){
           ...
           $("#canvas").attr("width", $("#div1").width());
           $("#canvas").attr("height",$("#div1").height());
           alert($("#div1").width());
           alert($("#div1").height());
